    ...
    public static void main(String[] args) {
        ...
        Pattern p = Pattern.compile(
                "((([0-9a-fA-F]{1,4}:){1,7})([0-9a-fA-F]{1,4}))"+ // Полное соответсвие *:*:*:*:*:*:*:*
                        ...
                        "((([0-9a-fA-F]{1,4}:){1,2})(:([0-9a-fA-F]{1,4})){1,5})|"+ // При отсутсвие 3 блока *:*::*:*:*:*:*
                        "((([0-9a-fA-F]{1,4}:){1,3})(:([0-9a-fA-F]{1,4})){1,4})|"+ // При отсутсвие 4 блока *:*:*::*:*:*:*
                        "((([0-9a-fA-F]{1,4}:){1,4})(:([0-9a-fA-F]{1,4})){1,3})|"+ // При отсутсвие 5 блока *:*:*:*::*:*:*
                        "((([0-9a-fA-F]{1,4}:){1,5})(:([0-9a-fA-F]{1,4})){1,2})|"+ // При отсутсвие 6 блока *:*:*:*:*::*:*
                        "((([0-9a-fA-F]{1,4}:){1,6})(:([0-9a-fA-F]{1,4})))|"+ // При отсутсвие 7 блока *:*:*:*:*:*::*
                        "((([0-9a-fA-F]{1,4}:){1,7}):)|"+ // При отсутствие 8 блока *:*:*:*:*:*:*::
                        "(:(((:[0-9a-fA-F]{1,4}){1,7})|:))" /* При отстутсвие 1 блока ::*:*:*:*:*:*:* или ::* и так далее с другими
